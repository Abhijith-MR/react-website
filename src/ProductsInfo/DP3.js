    ...
    <div>
      ...
      <div className='Middle'>
        <div className='MiddleLeft'>
          <img className='Image' src={myImage3} alt="My Image" />
          <img className='Image' src={D3} alt="My Image" />
        </div>
        ...
        <div className='MiddleRight'>
          ...
          <p className='price'>₹{estimatedCost}</p>
           {!showCheckout && (
                <Link to='/Checkout'>
                  <Link to={`/Checkout?cardName=DP3&quantity=${quantity}`}>
          ...
          <div className='Details'>
            ...
            <p>Here at MIRAGE HOTEL, multiple spaces are available for rent.</p>
          </div>
